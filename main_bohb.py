...
# print(tpe_loss)
for i in range(0,30):
    filepath = '/vol/projects/lchen/result/bohb/loss_time_bohb' + str(i) + '.csv'
    hpo.search_parameter_bohb(377, train_data, kfold=62, iterations=200, save=True, filepath=filepath)
