...
# print(tpe_loss)
for i in range(0,30):
    filepath = '/vol/projects/lchen/result/anneal/loss_time_anneal' + str(i) + '.csv'
    hpo.search_parameter_anneal(train_data, kfold=62, iterations=100, save=True, filepath=filepath)
