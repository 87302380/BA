...
# print(tpe_loss)
for i in range(0,30):
    filepath = '/vol/projects/lchen/result/hyperband/loss_time_hyperband' + str(i) + '.csv'
    hpo.search_parameter_hyperband(377, train_data, kfold=62, iterations=200, save=True, filepath=filepath)
